...
const socialLinks = [
    {
        name: "INSTAGRAM",
        url: "http://instagram.com/digitalnotice",
        icon: <FaInstagram />,
    },
    {
        name: "LINKEDIN",
        url: "http://linkedin.com/company/digitalnotice",
        icon: <FaLinkedin />,
    },
    {
        name: "FACEBOOK",
        url: "https://facebook.com/digitalnoticemedia",
        icon: <FaFacebook />,
    },
    {
        name: "TWITTER",
        url: "http://twitter.com/digital_notice",
        icon: <FaTwitter />,
    },
];
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-4 md:px-24 h-full flex flex-col justify-between py-12 md:py-24 relative z-10">
                ...
                {/* Button to Redirect to Typeform */}
                <motion.div className="mt-auto" variants={itemVariants}>
                    <motion.button
                        onClick={() =>
                            (window.location.href =
                                "https://form.typeform.com/to/bpDQ4VHB")
                        }
                ...
                >
                    ...
                    >
                        ...
                        >
                            <span>
                                © 2018-2025 Digital Notice Media Labs - All
                                Rights Reserved
                            </span>
